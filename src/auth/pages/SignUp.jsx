...
export function SignUp(){
    ...
    return (
        <div className="flex h-full flex-column sign-up">
            <form className="auth-form w-27rem mt-4 m-auto pt-2 pb-2 flex flex-column align-items-center justify-content-center">
                ...
                <div className="flex flex-column gap-2">
                    ...
                    <InputText type="password" id="password" aria-describedby="username-help" placeholder="Ingresa tu contraseña"
                               onChange={(e)=>setters.setPassword(e.target.value)}
                    />
                </div>
                <div className="flex flex-column gap-2">
                    <label htmlFor="repeatPassword">Repetir contraseña</label>
                    <InputText type="password" id="repeatPassword" aria-describedby="username-help" placeholder="Repite tu contraseña"
                    />
                </div>
